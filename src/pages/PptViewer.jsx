...
const PptModal = ({ open, handleClose, pptFile, currentPageIndex, setCurrentPageIndex }) => {
    ...
    if (!pptFile || !pptFile.hasOwnProperty("pageImgUrlList")) {
        return (
            <Modal open={open} onClose={handleClose}>
                <div style={{ background: "black" }}>
                    <p style={{ color: "white" }}>Error: PPT file data is missing or invalid.</p>
    ...
    return (
        <Modal open={open} onClose={handleClose}>
            <Grid container spacing={2} style={{ background: "black", marginTop: '5px' }} >
                <div
                    style={{
                        position: "absolute",
                        top: "10px",
